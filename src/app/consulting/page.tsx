...
export const metadata: Metadata = {
  ...
  description:
    "Discover and learn more about our extensive range of services, tailored uniquely to your organisations needs",
  openGraph: {
    title: "Consulting - Skylink Impact",
    description:
      "Discover and learn more about our extensive range of services, tailored uniquely to your organisations needs",
    ...
    <>
      ...
      <VStack className="w-full items-center justify-center bg-slate-50">
        <VStack className="container items-center justify-center px-4 py-12">
          ...
          <p className="italic text-center lg:w-3/4">
            Discover and learn more about our extensive range of services,
            tailored uniquely to your organisations needs
          </p>
          ...
          <VStack className="mt-9">
            ...
            <div className="grid lg:grid-cols-2 lg:grid-rows-4 gap-10 mt-8 text-justify justify-items-center">
              <InfoCard
                ...
                description="Elevate your organisation with our expert business consultants. We'll
              ...
              <InfoCard
                image={agileCoachingImg}
                title="Agile Coaching"
                description="With our Agile Coaching solutions, we will empower your teams to adapt, innovate and
                                thrive
              ...
              <InfoCard
                ...
                description="By leveraging AI's transformative potential, we create intelligent AI-powered
              ...
              <InfoCard
                ...
                description="Gain valuable insights into your organisation's challenges with our expert
                                analysis. We
              ...
              <InfoCard
                ...
                description="We will transform your organisation's ideas into successful products. Our expert product managers guide every step of the process, from ideation to market, ensuring successful offerings and providing product development services."
              />
            </div>
          </VStack>
        </VStack>
        ...
        <VStack className="container items-center justify-center py-12 px-4 gap-10">
          ...
          <div className="grid lg:grid-cols-2 place-items-center gap-8">
            ...
            <VStack className="gap-4 text-justify">
              <p>
                Our distinctive consulting approach is rooted in our ability to
                create, strategize, and execute refined digital business
                solutions that are not only uniquely suited to individual
                development, but include business elevation, process improvement
                and quality assurance enhancements, for organisations.
              </p>
              <p>
                We guarantee not only a tangible transformation but a remarkable
                journey toward realizing your desired change and growth.
              </p>
              <p>
                {" "}
                Our innovative strategies encompass a broad spectrum, ranging
                from advanced IT solutions and seamless software integration to
                comprehensive business security and development endeavors.
              </p>
              <p>
                Quality assurance and process improvements are our watchwords.
                We are Tech driven, Quality assured.
              </p>
            </VStack>
          </div>
        </VStack>
