        ...
        <>
            ...
            <VStack className="w-full bg-slate-50 items-center justify-center px-4 py-8">
                <VStack className="lg:w-3/5 gap-3">
                    <p>
                        Our product management services utilize tools and frameworks to develop and launch successful IT
                        products and services. We focus on defining product strategy, development, and market fit using
                        tools like Trello and Asana.
                    </p>

                    <p>
                        Our product management services are guided by a structured process that ensures successful
                    ...
                    <p>
                        We ensure your product meets market demands and user needs.
                    </p>
                </VStack>
            </VStack>
        </>
