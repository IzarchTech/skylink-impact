...
export default function Drawer({
  ...
  return (
    <>
      <div
        className="inset-0 fixed transition-opacity bg-opacity-75 bg-black z-[1400]"
        onClick={onClose}
      />
        ...
        <VStack>
          ...
          <VStack className="px-4 gap-4">
            <NavDropDown title="About Us">
              <Link onClick={onClose} href="/about_us">
                Who We Are
              </Link>
              <Link onClick={onClose} href="/about_us/meet_the_team">
                Meet The Team
              </Link>
            </NavDropDown>
            <Link onClick={onClose} href="/consulting">
              Consulting
            </Link>
            <Link onClick={onClose} href="/mentoring">
              Mentoring
            </Link>
            ...
            <Link onClick={onClose} href="/contact_us">
              Contact Us
            </Link>
          </VStack>
        </VStack>
