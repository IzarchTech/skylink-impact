            ...
            <div className="container mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4  p-4 py-8">
                <VStack className="space-y-6" isFull>
                    ...
                    <VStack className="space-y-2 text-xs" isFull>
                        <Link href="/about_us/who_we_are">About Us</Link>
                ...
                <VStack className="space-y-6" isFull>
                    ...
                    <VStack className="space-y-2 text-xs" isFull>
                        <Link href="/courses#software_quality_assurance">Software Quality Assurance</Link>
                        <Link href="/courses#business_analysis">Business Analysis</Link>
                        <Link href="/courses#software_development">Software Development</Link>
                        <Link href="/courses#product_management">Product Management</Link>
